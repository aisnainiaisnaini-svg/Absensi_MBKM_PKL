...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update_mbkm') {
    ...
    // setelah sukses:
    header('Location: ' . APP_URL . '/app/Participants/admin_participants_mbkm.php?updated=1');
    exit();
}
?>
<!DOCTYPE html>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar p-0">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link" href="<?= APP_URL ?>/app/Participants/admin_participants.php"><i class="fas fa-user-graduate me-2"></i>Kelola
                        Peserta</a>
                    <a class="nav-link active" href="<?= APP_URL ?>/app/Participants/admin_participants_mbkm.php"><i class="fas fa-user me-2"></i>Kelola
                        MBKM</a>
                    <a class="nav-link" href="<?= APP_URL ?>/app/Participants/admin_participants_pkl.php"><i class="fas fa-user me-2"></i>Kelola PKL</a>
                    <a class="nav-link" href="<?= APP_URL ?>/app/Guidance/admin_bimbingan_pkl.php"><i class="fas fa-chalkboard-teacher me-2"></i>Bimbingan
                        PKL</a>
                    <a class="nav-link" href="<?= APP_URL ?>/app/Leave/leave_approval.php"><i class="fas fa-check-circle me-2"></i>Persetujuan
                        Izin</a>
                    <a class="nav-link" href="<?= APP_URL ?>/app/Reports/reports_review.php"><i class="fas fa-clipboard-check me-2"></i>Review
                        Laporan</a>
            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="<?= APP_URL ?>/app/Participants/admin_participants_mbkm.php" class="btn btn-secondary">
