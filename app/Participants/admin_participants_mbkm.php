...
// Ambil semua divisi untuk filter (jika nanti mau ditambah)
...
<body>
    ...
    <div class="sidebar d-flex flex-column" id="adminSidebar">
        ...
        <nav class="nav flex-column flex-grow-1 px-2 py-3">
            ...
            <a class="nav-link active" href="<?= APP_URL ?>/app/Participants/admin_participants_mbkm.php"><i class="fas fa-user me-2"></i>Kelola MBKM</a>
    ...
    <div class="main-content p-4 p-lg-5">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
            <h2 class="mb-0"><i class="fas fa-user-graduate me-2"></i>Data Mahasiswa MBKM</h2>
            <a href="<?= APP_URL ?>/app/Participants/admin_add_mbkm.php" class="btn btn-primary">
                        ...
                        <?php if (!empty($participants)): ?>
                            <?php $no = 1; foreach ($participants as $p): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= APP_URL ?>/app/Participants/admin_edit_participant_mbkm.php?user_id=<?= $p['user_id'] ?>"
