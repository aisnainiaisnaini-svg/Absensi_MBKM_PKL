...
if ($_POST && isset($_POST['action']) && $_POST['action'] === 'add_mbkm') {
    ...
    if ($username && $email && $full_name && $password && $division && $start && $end) {
        ...
        if ($exist) {
            ...
            header('Location: ' . APP_URL . '/app/Participants/admin_participants_mbkm.php');
            exit();
            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="<?= APP_URL ?>/app/Participants/admin_participants_mbkm.php" class="btn btn-outline-secondary">
