        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar p-0">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="participants_pkl.php"><i class="fas fa-user me-2"></i>Kelola
                        PKL</a>
            ...
            <div class="col-md-9 col-lg-10 p-4">
                ...
                <div class="d-flex justify-content-end mb-3">
                    <a href="add_pkl.php" class="btn btn-primary">
                ...
                <div class="alert alert-success">
                    ...
                    Siswa PKL berhasil ditambahkan!
                </div>
                <?php endif; ?>
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_participant_pkl.php?user_id=<?= $p['user_id'] ?>"
                                ...
                                <?php else: ?>
                                <tr>
                                    <td colspan="10" class="text-center text-muted">Tidak ada data siswa PKL</td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
