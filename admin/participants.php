...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar p-0">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link" href="bimbingan_pkl.php"><i class="fas fa-chalkboard-teacher me-2"></i>Bimbingan PKL</a>
    ...
    <tbody>
        <?php if (!empty($participants)): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <tr><td colspan="11" class="text-center text-muted">Tidak ada data peserta</td></tr>
        <?php endif; ?>
    </tbody>
</table>
                    </div>
