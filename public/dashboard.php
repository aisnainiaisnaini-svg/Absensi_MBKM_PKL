...
$base_path = '../'; // For accessing files in app directory from public directory
...
?>
<?php $title = 'Dashboard - Aplikasi Pengawasan Magang/PKL'; include BASE_PATH . 'app/Core/_includes/header.php'; ?>
